...
const markColorInput = document.getElementById('mark-color-input')

const changeMarkColor = () => {
	ctxOD.strokeStyle = markColorInput.value
	ctxOS.strokeStyle = markColorInput.value	
}
...
const bgOD = GIF()
bgOD.load('./../img/eye_OD.gif')
bgOD.onload = function() {
  ctxOD.drawImage(bgOD.frames[0].image, 0, 0, canvasOD.width, canvasOD.height)
}

const bgOS = GIF()
bgOS.load('./../img/eye_OS.gif')
bgOS.onload = function() {
  ctxOS.drawImage(bgOS.frames[0].image, 0, 0, canvasOS.width, canvasOS.height)
}
